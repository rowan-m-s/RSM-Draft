...
describe('buildPlayers', () => {
  ...
  const elements = [
    { id: 1, code: 154561, web_name: 'Raya', element_type: 1, team: 1, total_points: 162, points_per_game: '4.4', goals_scored: 0, assists: 0, clean_sheets: 19, bonus: 11 },
    { id: 2, code: 223094, web_name: 'Haaland', element_type: 4, team: 2, total_points: 239, points_per_game: '6.8', goals_scored: 27, assists: 8, clean_sheets: 13, bonus: 43 },
    { id: 3, code: 209289, web_name: 'Rice', element_type: 3, team: 1, total_points: 184, points_per_game: '5.1', goals_scored: 4, assists: 9, clean_sheets: 18, bonus: 23 },
  ]

  it('splits owned from free agents and finds the leading scorer', () => {
    const result = buildPlayers({
      elements,
      teams,
      ownerByElementId: new Map([[2, 'rushy']]),
      generatedAt: 'x',
    })
  ...
  it('builds the photo reference from `code`, which Draft uses instead of `photo`', () => {
    const result = buildPlayers({ elements, teams, ownerByElementId: new Map(), generatedAt: 'x' })
